        ...
        try:
            ...
            if guess == self.secret_number:
                ...
                if difference <= 5:
                    ...
                    hint = "Close! Go higher"
                else:
                    hint = "Too low! Go much higher"
